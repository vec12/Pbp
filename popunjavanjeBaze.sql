...
insert into montazer values(1000, 'viseci-element', 2);
...
insert into planDostave values('2017-12-10', 'Dr Ivana Ribara 144', 2),
       	    		('2017-12-12', 'Dr Ivana Ribara 144', 2),
       	    		('2017-12-20', 'Dr Ivana Ribara 45', 2);

insert into kupljenNamestaj values(1, 1, '2017-12-10'),
       	    		    (2, 1, '2017-12-10'),
			    (3, 1, '2017-12-12');
			    -- (4, 2, '2017-12-20');
